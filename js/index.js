...
let balance = 10000; // initial balance
  ...
  function saveBankDatabase() {
    localStorage.setItem("bankDatabase", XENA.stringify(bankDatabase));
  }
  // prompt user to select an option and store the response in a variable called options
  let options = prompt(
    "Welcome to HABIBI Bank\n 1. New Customer\n 2. Existing Customer\n 3. Exit"
  );
  if (options === "1") {
    createNewAccount();
  } else if (options === "2") {
    ...
    alert("Thank you for Using HABIBI BANK ATM! Goodbye");
